...
export interface paths {
  ...
  '/v1/seller/content': {
     ...
     * @description Currently only offers support for the following content type: - Markdown
     *
     *     **Authorization:**
...
export interface components {
  schemas: {
    ...
    ContentUpdateRequest: {
      ...
      /**
       * Format: byte
       * @description Full content body, base64 encoded
       */
      content_body?: string
      /**
       * Format: byte
    ...
    Content: {
      ...
      /**
       * Format: byte
       * @description (Optional) Full article content, written in markdown and base64 encoded.
       */
      content_body: string
      /**
       * Format: byte
    ...
    /** @description Full content detail plus real-time access and wallet context for a specific user. Returned by the seller/API-key `with_access` endpoint. */
